...
hybrid systems with parametric uncertainty by applying the implemented tool {\bf SReach} to two representative examples - the prostate cancer treatment control and the cardiac system, and further through applications to additional benchmarks.