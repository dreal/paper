...
set logscale y
plot 'thermostat-double.dat' u 1:2 w lp ls 1 t 'new (unsat)', 'thermostat-double.dat' u 1:3 w lp ls 2 t 'heuristic (unsat)', 'thermostat-double.dat' u 1:4 w lp ls 3 t 'standard (unsat)', 'thermostat-double.dat' u 1:5 w lp ls 4 t 'new (sat)', 'thermostat-double.dat' u 1:6 w lp ls 5 t 'heuristic (sat)', 'thermostat-double.dat' u 1:7 w lp ls 6 t 'standard (sat)'
