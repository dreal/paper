...
set terminal postscript eps colour dashed dl 20 size 3.685,2.2
set output 'airplane-multi.eps'
set key outside right top vertical Right noreverse noenhanced autotitle nobox
set datafile missing '-'
set key bottom

#set grid
set title "Multirate Airplane" 
...
set logscale y
plot 'airplane-multi.dat' u 1:2 w lp ls 1 t 'new (unsat)', 'airplane-multi.dat' u 1:3 w lp ls 2 t 'heuristic (unsat)', 'airplane-multi.dat' u 1:4 w lp ls 3 t 'standard (unsat)', 'airplane-multi.dat' u 1:5 w lp ls 4 t 'new (sat)', 'airplane-multi.dat' u 1:6 w lp ls 5 t 'heuristic (sat)', 'airplane-multi.dat' u 1:7 w lp ls 6 t 'standard (sat)'
