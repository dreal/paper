...
set logscale y
plot 'battery-double.dat' u 1:2 w lp ls 1 t 'new (unsat)', 'battery-double.dat' u 1:3 w lp ls 2 t 'heuristic (unsat)', 'battery-double.dat' u 1:4 w lp ls 3 t 'standard (unsat)', 'battery-double.dat' u 1:5 w lp ls 4 t 'new (sat)', 'battery-double.dat' u 1:6 w lp ls 5 t 'heuristic (sat)', 'battery-double.dat' u 1:7 w lp ls 6 t 'standard (sat)'
