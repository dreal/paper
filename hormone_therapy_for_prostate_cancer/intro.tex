...
-- First, we show that our model is in good agreement with the published clinical data in literature \cite{ bruchovsky06,bruchovsky07}. %the sentence is weak. Add more explanations as well. 

-- Second, we obtain interesting insights on cancer cell proliferation dynamics through analysis of the nonlinear model. %explanation
