...
%In this section, we present some $\delta$-reachability analysis techniques we have developed for hybrid models in systems biology. 
...
%todo
% - what is $\delta$ decision
% - how to analyze hybrid system
