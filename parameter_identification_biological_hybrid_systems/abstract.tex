...
we present a parameter synthesis framework based on $\delta$-complete decision procedures.
...
Our results show that the parameter synthesis framework is convenient and efficient. Also,
