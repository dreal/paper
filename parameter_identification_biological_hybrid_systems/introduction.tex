...
a highly nonlinear hybrid model which is out of the scope of state-of-the-art tools. In particular, 
we analyzed a cardiac cell action potential model \cite{orovio08} and we identified parameter ranges 
for which a cardiac cell may lose excitability.
...
is found to be unfeasible, then this is correct (see below for more information).
