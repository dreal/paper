...
\end{align*}
\end{definition}
By computable we mean Type 2 computable, which informally requires that a (real) function may
be evaluated with arbitrary accuracy --- for more details see the Appendix.
