...
\begin{multline*}
\forall\vec{x} \in [4.0, 6.3504]^5\Big(- \mathrm{atan2}(\sqrt{\Delta_1(\vec{x})}, - \Delta_2(\vec{x})) - 0.458(\sqrt{x_2} + \sqrt{x_3} +\sqrt{x_4} + \sqrt{x_5})\\
 + 0.342\sqrt{x_1} + 3.319204 < 0.0\Big)
\end{multline*}
where
\begin{eqnarray*}
%give this definition
\mathrm{atan2} &=& 2 \mathrm{arctan} \frac{y}{\sqrt{x^2 + y^2} + x}\\
