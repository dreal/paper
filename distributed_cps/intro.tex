...
systems for: turning an airplane, controlling the altitude of a quad-rotor UAV,
 controlling the water level in a power plant,  networked water tank
...
\textbf{(Peter) I added the applications above from the commented-out
  list below..}
