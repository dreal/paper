...
set logscale y
plot 'airplane-multi.dat' u 1:2 w lp ls 1 t 'new (unsat)', 'airplane-multi.dat' u 1:4 w lp ls 3 t 'standard (unsat)', 'airplane-multi.dat' u 1:5 w lp ls 4 t 'new (sat)', 'airplane-multi.dat' u 1:7 w lp ls 6 t 'standard (sat)'
