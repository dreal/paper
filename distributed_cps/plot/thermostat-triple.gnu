...
set grid
set title "Networked thermostats (triple)" 
set yrange [1:100000]
set ylabel 'time (s)'
...
set logscale y
plot 'thermostat-triple.dat' u 1:2 w lp ls 1 t 'new (unsat)', 'thermostat-triple.dat' u 1:4 w lp ls 3 t 'standard (unsat)', 'thermostat-triple.dat' u 1:5 w lp ls 4 t 'new (sat)', 'thermostat-triple.dat' u 1:7 w lp ls 6 t 'standard (sat)'
